...
import com.example.apppruebasmisiontic.databinding.ActivityMapaBinding;
...
public class MapaActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Button btn_guardar_ubicacion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_guardar_ubicacion = findViewById(R.id.btn_guardar_ubicacion);
        ...
        btn_guardar_ubicacion.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng calarca = new LatLng(4.523143, -75.6627261);
        mMap.addMarker(new MarkerOptions().position(calarca).title("Marker in Calarca city"));
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(@NonNull LatLng latLng) {
                btn_guardar_ubicacion.setEnabled(true);
                Log.e("PUNTO", latLng.latitude + " - " + latLng.longitude);
                mMap.clear();
                miubicacion = latLng;
